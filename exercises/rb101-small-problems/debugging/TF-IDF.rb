...
for a particular document in a document collection. However, he just started learning to code and somehow his
numbers do not match what is expected. He knows you're enrolled in an awesome developer school, so he asks you to have a look.
=end
...
# The bug was on line 34, it was performing integer division. We can use `fdiv` will divide floats and return a float.