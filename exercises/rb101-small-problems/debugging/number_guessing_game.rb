...
# the bug was in that on line 41 we did not need to call the function again, we simply come back to the top of the loop.
# the other issue was that we needed to break the loop after winning