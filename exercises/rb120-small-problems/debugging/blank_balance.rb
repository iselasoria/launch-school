...
# S:
# the fix was to make use of the method `valid_transaction?` which checks if the withdrawl amount would put us in the negative
# this is used as the condition to the tansaction, instead of the check for whether the requested amount is a positive number