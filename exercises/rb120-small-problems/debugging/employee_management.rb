...
Each employee must have a unique serial number.
However, when we are testing our program, an exception is raised.
...
class Employee
  ...
  protected # this used to be private
...
# S:
# The solution here was to make the reader for serial_number protected rather than private
# protected methods behave the same as private from outside the class. However, from inside the class
# protected methods CAN be called with an exmplicit caller
# todo mental model