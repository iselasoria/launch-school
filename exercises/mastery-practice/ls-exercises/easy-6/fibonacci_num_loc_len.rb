...
considering that it takes 6 iterations before it generates the first 
2 digit number.
...
Examples:
Fibonacci Rules:
- a number in the sequence is the result of the previous two numbers

=end 

def find_fibonacci_index_by_length(length_digits)
  first = 1
  second = 1
  index = 2
  ...
  loop do 
    ...
    break if fibonacci.to_s.size >= length_digits
